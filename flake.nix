      ...
      let
        ...
        chromium-bin =
          if pkgs.stdenv.hostPlatform.isDarwin then
            "${pkgs.playwright-driver.browsers}/chromium-${chromium-rev}/chrome-mac-arm64/Google Chrome for Testing.app/Contents/MacOS/Google Chrome for Testing"
          else
            "${pkgs.playwright-driver.browsers}/chromium-${chromium-rev}/chrome-linux64/chrome";
      in
      {
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            export PLAYWRIGHT_LAUNCH_OPTIONS_EXECUTABLE_PATH="${chromium-bin}"
          '';
        };
