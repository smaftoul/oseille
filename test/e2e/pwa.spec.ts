...
test.describe("PWA installability", () => {
  ...
  test("install button triggers pwa-install dialog on demand", async ({ page }) => {
    const pwaInstall = page.locator("pwa-install");
    await expect(pwaInstall).toBeAttached();
