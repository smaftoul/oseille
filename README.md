...
Install prompt: `@khmyznikov/pwa-install` shows browser-specific instructions automatically (iOS Chrome/Firefox/Safari steps, Android native prompt).
